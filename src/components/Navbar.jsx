...
const Navbar = ({theme, setTheme}) => {
  ...
  return (
    ...
    z-50 backdrop-blur-xl font-medium bg-white/95 dark:bg-gray-900/70 shadow-sm'>
      ...
      max-sm:text-white max-sm:pt-20 flex sm:items-center gap-5 transition-all `}>
        {/* for menuClose */}
        <img src={assets.close_icon} alt="" className='sm:hidden absolute w-5 right-4 top-4'
      ...
      <div className='flex gap-2 sm:gap-4 items-center'>
        ...
        text-white px-6 py-2 rounded-full cursor-pointer hover:scale-103 transition-all'>
          Connect
          <img src={assets.arrow_icon} width={14}/>
        </a>
      </div>
